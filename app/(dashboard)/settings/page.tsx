  ...
  return (
    <div className="p-6 max-w-[1400px] mx-auto">
      ...
      <p className="text-sm text-[var(--color-text-tertiary)]">
        Team, permissions, integrations, and notifications — coming in the next sprint.
      </p>
      <div className="mt-8 rounded-[12px] border border-[var(--color-border-brand)] bg-[var(--color-surface)] p-12 text-center">
        ...
        <p className="text-[var(--color-text-secondary)] text-sm">Workspace settings, user roles, and integration configuration will live here.</p>
      </div>
    </div>
  )
}
