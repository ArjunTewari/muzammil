...
const STEPS = [
  {
    ...
    body: "Supra takes the founder's judgment — their standards, their experience — out of their head and puts it into a system, so quality doesn't depend on them being in the room.",
  },
  {
    icon: Workflow,
    iconColor: 'var(--color-gold)',
  ...
  },
  {
    ...
    body: 'The founder sees every employee, the campaign each is running, and exactly what their agents are producing — plus every invoice, approval and lead — without asking anyone for an update.',
  },
  {
    icon: CheckCircle2,
    iconColor: '#4ade80',
    title: "You're all set",
    body: 'Sign in as the Founder to see the whole business, or as any employee to run a campaign with their agent suite. Re-open this tour anytime from the ? in the top bar.',
  },
]
